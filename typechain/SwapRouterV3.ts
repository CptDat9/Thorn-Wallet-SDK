...
export interface SwapRouterV3Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "WETH9"
      | "deployer"
...
export interface SwapRouterV3 extends BaseContract {
  connect(runner?: ContractRunner | null): SwapRouterV3;
  waitForDeployment(): Promise<this>;

  interface: SwapRouterV3Interface;
